...
import './App.css';
import { Home, Archive, Bell, User, Play, LogOut, Lightbulb, FileText, Sparkles, Clock, TrendingUp, Settings } from 'lucide-react';
...
function AuthRedirect({ onShowAuthModal }) {
    useEffect(() => { onShowAuthModal(); }, [onShowAuthModal]);
    return null;
}
